...
new.cluster.ids <- c("Epithelial cells", "Mesenchymal cells", "Neuronal cells", "RBCs", "Endothelial cells", "Immune cells")
names(new.cluster.ids) <- levels(category)
category <- RenameIdents(category, new.cluster.ids)
